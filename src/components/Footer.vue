        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-sm-4 col-md-3">
                    <h6 class="footer__title">Sobre nós</h6>
                ...
                <!-- footer list -->
                <div class="col-6 col-sm-4 col-md-3">
                    <h6 class="footer__title">Outros</h6>
                    <ul class="footer__list">
                ...
                <div class="col-12 col-sm-4 col-md-3">
                    <h6 class="footer__title">Contato</h6>
                    <ul class="footer__list">
                        <li><a href="tel:+18002345678">+55 21 98169-2318</a></li>
                ...
                <div class="col-12">
                    <div class="footer__copyright">
                        <small><a target="_blank" href="https://www.templateshub.net">VUEFLIX</a></small>
